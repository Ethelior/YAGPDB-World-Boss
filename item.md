...
{{$items.Set "atkboost" (sdict
    "name" "Attack Boost"
    "emoji" "⚔️"
)}}

{{$items.Set "defboost" (sdict
    "name" "Defense Boost"
    "emoji" "🛡️"
)}}

{{$items.Set "xpboost" (sdict
    "name" "XP Boost"
    "emoji" "⭐"
)}}

{{$items.Set "tokenboost" (sdict
    "name" "Token Boost"
    "emoji" "🪙"
)}}
...
{{$items.Set "bag1" (sdict
    "name" "Inventory Upgrade I"
    "emoji" "🎒"
)}}

{{$items.Set "bag2" (sdict
    "name" "Inventory Upgrade II"
    "emoji" "🎒"
)}}

{{$items.Set "bag3" (sdict
    "name" "Inventory Upgrade III"
    "emoji" "🎒"
)}}

{{/* Special */}}

{{$items.Set "lucky" (sdict
    "name" "Lucky Charm"
    "emoji" "💎"
)}}

{{$items.Set "knowledge" (sdict
    "name" "Ancient Knowledge"
    "emoji" "📜"
)}}

{{$items.Set "emblem" (sdict
    "name" "Warrior's Emblem"
    "emoji" "🗡️"
)}}

{{$items.Set "crest" (sdict
    "name" "Guardian's Crest"
    "emoji" "🛡️"
)}}

{{$items.Set "vitality" (sdict
